...
import SalesHistory from './pointOfSaleComponents/SalesHistory'
import PurchaseOfConsumables from './pointOfSaleComponents/PurchaseOfConsumables'
import Products from './pointOfSaleComponents/products'
